...
repo_path ='.'
if (osName == 'Windows'):
    repo_path = 'E:\\WorkSpace\\EffectivePython'
    blog_path = 'E:\\WorkSpace\\EffectivePython\\source'
    index_path = 'E:\\WorkSpace\\EffectivePython\\README.md'

base_link = "https://effectivepython.readthedocs.io/zh_CN/latest/"
...
def init_index_info():
    ...
    for file in os.listdir(chapter_dir):
        ...
        index_info[name.replace("ch", "")] = {"name": chapter_name, "contents": []}
    return index_info
...
def main(index_info):
    for folder in get_all_dir():
        ...
        for file in all_md_file:
            ...
            index_info[chapter.replace("ch", "")]["contents"].append(line)
